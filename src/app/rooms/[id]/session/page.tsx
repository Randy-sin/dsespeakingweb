            ...
            {isDiscussionOrIR ? (
              ...
              <div className="grid lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-6">
                  <div className="rounded-xl border border-neutral-200/70 p-5">
                    <p className="text-[12px] text-neutral-400 mb-1">
                      {paper.year} · {paper.paper_number}
                    </p>
                    <h3 className="font-serif text-[22px] font-semibold text-neutral-900 mb-3">
                      {paper.part_a_title}
                    </h3>
                  ...
                  {room.status === "preparing" && !isObserver && (
                    <div className="rounded-xl border border-neutral-200/70 p-4">
                      <p className="text-[12px] text-neutral-400 uppercase tracking-wide mb-2">
                        Notes
                      </p>
                      <Textarea
                        value={notes}
                        ...
                        className="min-h-[160px] resize-y text-[14px] border-neutral-200 focus-visible:ring-neutral-400"
                      />
                    </div>
                  )}
                </div>
