...
export const metadata = buildPageMetadata({
  title: "DSE Group Discussion 練習",
  description:
    "選擇 HKDSE Speaking 小組討論題目，練習回應觀點、補充理由與例子、邀請組員接話，並取得 AI 回饋。",
